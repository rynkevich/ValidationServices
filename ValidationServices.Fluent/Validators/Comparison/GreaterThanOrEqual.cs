...
{
    /// <summary>
    /// Validator that verifies that property is greater than or equal to the specified value.
    /// </summary>
    public class GreaterThanOrEqualValidator : AbstractComparisonValidator
    {
        ...
        /// <summary>
        /// Initializes a new instance of <see cref="GreaterThanOrEqualValidator"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Checks if <paramref name="objectToValidate"/> is greater than or equal to <paramref name="comparisonValue"/>
        /// </summary>
