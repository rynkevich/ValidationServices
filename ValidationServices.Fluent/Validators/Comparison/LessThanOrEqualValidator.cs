...
{
    /// <summary>
    /// Validator that verifies that property is less than or equal to the specified value.
    /// </summary>
    public class LessThanOrEqualValidator : AbstractComparisonValidator
    {
        ...
        /// </summary>
        public static string DefaultFailureMessage { get; } = Resources.Validators.LessThanOrEqualValidatorDefaultFailureMessage;

        /// <summary>
        /// Initializes a new instance of <see cref="LessThanOrEqualValidator"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Checks if <paramref name="objectToValidate"/> is less than or equal to <paramref name="comparisonValue"/>
        /// </summary>
