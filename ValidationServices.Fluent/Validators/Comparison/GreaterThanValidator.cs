...
{
    /// <summary>
    /// Validator that verifies that property is greater than the specified value.
    /// </summary>
    public class GreaterThanValidator : AbstractComparisonValidator
    {
        ...
        /// </summary>
        public static string DefaultFailureMessage { get; } = Resources.Validators.GreaterThanValidatorDefaultFailureMessage;

        /// <summary>
        /// Initializes a new instance of <see cref="GreaterThanValidator"/> class.
        /// </summary>
        ...
        /// <summary>
        /// Checks if <paramref name="objectToValidate"/> is greater than <paramref name="comparisonValue"/>
        /// </summary>
